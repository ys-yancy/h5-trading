...
Base.extend(Chart, Base, {
  ...
  _bind: function() {
    ...
    //   var width = $('#J_Chart').width();
    //   var height = $('#J_Chart').height();

    //   window.resizeFontSize && window.resizeFontSize();
  ...
  _initHightStock: function() {
    ...
    this.instance = new Highcharts.StockChart({
      chart: {
        ...
        backgroundColor: self.ui.background || '#150d22',
        reflow: true,
        zoomType: 'x',
        panning: true,
        zoomType: 'x',
      ...
      plotOptions: {
        candlestick: {
          lineColor: self.ui.downColor || '#27c1a7',
          upLineColor: self.ui.upColor || '#f74b47',
          color: self.ui.downColor || '#27c1a7',
          upColor: self.ui.upColor || '#f74b47',
        }
      },
      xAxis: {
        gridLineColor: self.ui.gridLineColor || '#20182d',
        gridLineWidth: 1,
      ...
      tooltip: {
        ...
        //     //return 'The value for ' + this.points[0].point.close + ' is ' + this.points[0].point.high ;
        // }
      }
    });
