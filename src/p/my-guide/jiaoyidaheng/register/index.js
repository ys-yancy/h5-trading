...
class Register extends PageBase {
  ...
  _bind() {
    ...
    this.subscribe('msg:sent', this._countdown, this);
  ...
  _submit(tel) {
    ...
    this.ajax({
      ...
      // dialog.setContent('识别扫码，关注交易大亨公众号，领取新用户注册红包。');
      // dialog.show();
      submitEl.val('马上注册');
  ...
  _showQR() {
    var self = this;
    var url = getWXDomainAodWL() + '/img/wl/jiaoyidaheng_wx_qrcode.png';
    var dialogQr = new Dialog({
      isShow: true,
