...
class Register extends PageBase {
  ...
  _bind() {
    ...
    $('#J_Form').on('submit', $.proxy(function(e) {
      var curEl = $(e.currentTarget),
        telEl = $('.tel', curEl),
        passwordEl = $('.password', curEl),
        tel = telEl.val(),
        password = passwordEl.val();
      e.preventDefault();

      this._submit(tel, password);
  ...
  _goRegister() {
    ...
    if (this.isWeixin()) {
      ...
      var wx = '<a class="aa" href="https://mp.weixin.qq.com/mp/profile_ext?action=home&scene=110&__biz=' + getWXIDWL() +'#wechat_redirect">点击关注微信公众号 享免费资讯服务</a>'
