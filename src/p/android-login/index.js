...
Base.extend(Register, PageBase, {
    ...
    _submit: function(e) {
        ...
        self.ajax({
            ...
            // console.log ('token=' + Cookie.get('token') + ' phone=' + Cookie.get('phone') + ' inviteCode=' + Cookie.get('inviteCode'));
    ...
    _initAttrs: function() {
        $('.register').attr('href', './register.html?src=' + encodeURIComponent(location.href));
