  ...
  _parse(data) {
    ...
    data.forEach((item) => {
      ...
      if (item.followerAvatar) {
        item.followerAvatar = config.getAvatarPrefix(item.followerAvatar);
      } else {
        item.followerAvatar = getDefaultIconWL();
      }

      if (item.followedAvatar) {
        item.followedAvatar = config.getAvatarPrefix(item.followedAvatar);
      } else {
        item.followedAvatar = getDefaultIconWL();
      }
